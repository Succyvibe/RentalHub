    ...
    <>
        ...
        <div className="w-full md:w-[50%]  mt-6 px-3">
          <form>
            ...
            <input
              ...
              onChange={onChange}
              className={`w-full px-4 py-2 text-xl text-gray-700bg-white border border-gray-300 rounded transition ease-in-out mb-6 ${
      ...
      <div className="max-w-6xl px-3 mt-6 mx-auto">
        {!loading && listings.length > 0 && (
          <>
            <h2 className="2xl text-center font-semibold mb-6 ">My Listings</h2>
