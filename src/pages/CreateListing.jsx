      ...
      <form onSubmit={onSubmit}>
        ...
        <div className=" flex items-center mb-6">
          <div>
            ...
            <div className="flex w-full justify-center items-center space-x-6">
              ...
              {type === "rent" && (
                <div>
                  <p className="text-md w-full whitespace-no-wrap">$ / Month</p>
                </div>
              )}
            </div>
          </div>
          ...
          <div className=" flex items-center mb-6">
            <div>
              ...
              <div className="flex w-full justify-center items-center space-x-6">
                ...
                {type === "rent" && (
                  <div>
                    <p className="text-md w-full whitespace-no-wrap">
                      $ / Month
                    </p>
                  </div>
                )}
        ...
        <div className="mb-6">
          ...
          <input
            ...
            multiple
            required
            className="w-full px-3 py-1.5 bg-white text-gray-700 border border-gray-300 rounded transition duration-150 ease-in-out focus:bg-white focus:border-slate-600 cursor-pointer"
          />
        </div>
        <button
          type="submit"
